...
<a href='#'><img id='rechlogo' src='rechlogo.png'/> </a>
	  	  ...
	  	  <form method='post' action='eq.php'>
	  ...
	  <div id ='c5'><input type='submit' value='Supprimer' id ='b5' name='supprimer'/></div>
			  ...
			  <br> <br> 
		  <div id=main2>
		  <p align='center' style='font-size:20px;'> E Q U I P E S </p>
          </div>

	  ";

	  /* L'affichage des equipe */
if(isset($_POST['liste']))
{
$t1=$c->getAll(); 
echo "<br><br><div id=main2>";
echo "<p align='center' style='font-size:20px;'> Liste des équipes </p>";
echo"<table align='center' font-weight='bold' id='m'><td>Id</td><td>Nom</td></table>";
      foreach ($t1 as $cc) {echo $cc;}
      echo"</div>";
}	  
	  /* L'ajout d'une equipe */

if(isset($_POST['ajout']))
{
echo "<br><br><div id=main2>";
echo "<p align='center' style='font-size:20px;'> Insertion d'une équipe </p>";
echo "<p  style='font-size:16px;'> Entrer les données à insérer </p>";
echo" <form method='post' action='eq.php'> 
	  <label>Id </label> <br><input id='txt' type='text' name='id_equipe' required/> 
	  <br><label>Nom </label> <br><input id='txt'  type='text' name='nom_equipe' required/> 
...
{
	echo "<br><br><div id=main2>";
	echo "<p align='center' style='font-size:20px;'> Suppression d'une équipe </p>";
	echo "<p  style='font-size:16px;'> Entrer l'identificateur de l'équipe </p>";
echo" <form method='post' action='eq.php'> 
	  <label>Id </label> <br><input id='txt' type='text' name='id_equipe' required/> 
...
echo"<table align='center' font-weight='bold' id='m'><td>Id</td><td>Nom</td></table>";
	 ...
	 /* modification sur une equipe */
		
		if(isset($_POST['modifier']))
{
	echo "<br><br><div id=main2>";
	echo "<p align='center' style='font-size:20px;'> Modification d'une équipe </p>";
...
echo"<table align='center' font-weight='bold' id='m'><td>Id</td><td>Nom</td></table>";
      ...
      echo"</div>";}
	  	 ...
	  	 /* affichage du nom de lequipe en entrant son id */
if(isset($_POST['select']))
{
	echo "<br><br><div id=main2>";
	echo "<p align='center' style='font-size:20px;'> Affichage dune équipe </p>";
	echo "<p  style='font-size:16px;'> Entrer l'identificateur de l'équipe </p>";
echo" <form method='post' action='eq.php'> 
	  <label>Id </label> <br><input id='txt' type='text' name='id_equipe' required/> 
